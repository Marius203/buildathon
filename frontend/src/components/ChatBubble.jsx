...
const THINKING_PHRASES = [
  "Asking the ravens", "Tuning the vibes", "Checking the lineup",
  "Reading the runes", "Bribing security", "Consulting the oracle",
  "Finding the stage", "Texting my guy", "Surviving the mud",
  "Decoding wristbands", "Top-up incoming", "Castle knows all",
  "Loading good vibes", "Almost there",
];
...
function AiAvatar({ size = 32 }) {
  return (
    <img
      src={bubbleLogo}
      alt="EC Assistant"
      className="ec-chat__msg-avatar-img"
  ...
  return (
    <div className="ec-chat">
      <div className="ec-chat__header">
        <div className="ec-chat__avatar">
          <AiAvatar size={36} />
        </div>
        <div style={{ flex: 1 }}>
          <div className="ec-chat__header-name">Vlad</div>
